...
\input{tablas/resumen_general.tex}
\end{table}
...
\input{tablas/diccionario_variables.tex}
\end{center}
...
\input{tablas/flujo_limpieza.tex}
\end{table}
...
\input{tablas/faltantes_original_mensual.tex}
\end{table}
...
\input{tablas/estadisticas_descriptivas.tex}
\end{table}
...
\resizebox{\textwidth}{!}{\input{tablas/correlaciones.tex}}
\end{table}
...
\input{tablas/correlaciones_total_chile.tex}
\end{center}
...
\label{tab:asimetria}
\input{tablas/asimetria_curtosis.tex}
\end{table}
...
\begin{itemize}[itemsep=0.2em]
    ...
    \item \code{tarea_1_limpieza_datos.ipynb}: notebook ejecutado con código, resultados y gráficos.
