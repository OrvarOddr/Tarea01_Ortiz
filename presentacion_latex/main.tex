...
\setbeamertemplate{headline}{%
  \begin{beamercolorbox}[wd=\paperwidth,ht=4.4ex,dp=1.2ex,leftskip=0.34cm,rightskip=0.34cm]{headlinebar}
    ...
    \hspace{0.22cm}{\color{white}\scriptsize\bfseries Universidad del Bío-Bío}%
...
\newcommand{\copperband}{%
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=west, text=white, font=\scriptsize\bfseries] at ([xshift=0.74cm,yshift=-0.24cm]current page.north west) {Universidad del Bío-Bío};
...
\begin{frame}[plain]
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=north east, fill=white, fill opacity=0.90, text opacity=1, rounded corners=3pt, inner sep=4pt] at ([xshift=-0.55cm,yshift=-0.45cm]current page.north east) {
      \includegraphics[height=1.05cm]{imagenes/logo_universidad_biobio.png}
    };
  \end{tikzpicture}
