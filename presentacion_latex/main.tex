...
\setbeamertemplate{headline}{%
  \begin{beamercolorbox}[wd=\paperwidth,ht=4.4ex,dp=1.2ex,leftskip=0.34cm,rightskip=0.34cm]{headlinebar}
    {\color{arena}\scriptsize Ciencia de Datos para Economía y Gestión}%
...
\newcommand{\copperband}{%
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=west, text=arena, font=\scriptsize] at ([xshift=0.34cm,yshift=-0.24cm]current page.north west) {Ciencia de Datos para Economía y Gestión};
